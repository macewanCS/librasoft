...
class Actions_Table_Seeder extends Seeder
{
    ...
    public function run()
    {
        ...
        DB::table('actions')->insert([
            ...
            'owner'=> "IT Services",
            'lead'=> "vvarga@epl.ca",
            'collaborators'=> "IT" . $SEPARATOR . "DLI",
            'status'=> "Ongoing",
        ...
        DB::table('actions')->insert([
            ...
            'owner'=> "IT Services",
            'lead'=> "jcrilly@epl.ca",
            'collaborators'=> "Marketing" . $SEPARATOR . "vvarga@epl.ca" . $SEPARATOR . "dceo@epl.ca",
            'status'=> "Completed",
            'success'=> "Yes",
            'created_at' => Carbon::now()->format('Y-m-d H:i:s'),
        ...
        DB::table('actions')->insert([
            ...
            'owner'=> "IT Services",
            'lead'=> "ejones@epl.ca",
            'collaborators'=> "FAO" . $SEPARATOR . "Marketing",
        ...
        DB::table('actions')->insert([
            ...
            'collaborators'=> "IT" . $SEPARATOR . "crachael@epl.ca" . $SEPARATOR . "R&A",
            'status'=> "Completed",
        ...
        DB::table('actions')->insert([
            ...
            'owner'=> "IT Services",
            'lead'=> "dpsl@epl.ca",
            'collaborators'=> "Adult Programming" . $SEPARATOR . "DLI" . $SEPARATOR . "IT",
            'status'=> "Completed",
            'success'=> "Yes",
            'created_at' => Carbon::now()->format('Y-m-d H:i:s'),
        ...
        DB::table('actions')->insert([
            ...
            'date'=> \Carbon\Carbon::createFromDate(2014, 01, 01)->toDateTimeString(),
            'owner'=> "IT Services",
            'lead'=> "pschoenberg@epl.ca",
            'collaborators'=> "IT" . $SEPARATOR . "Marketing" . $SEPARATOR . "FAO",
            'status'=> "In progress",
            'success'=> "Yes",
            'created_at' => Carbon::now()->format('Y-m-d H:i:s'),
            'updated_at' => Carbon::createFromDate(2016, 01, 28)->toDateTimeString(),
        ...
        DB::table('actions')->insert([
            ...
            'owner'=> "IT Services",
            'lead'=> "pschoenberg@epl.ca",
            'collaborators'=> "IT" . $SEPARATOR . "R&A" . $SEPARATOR . "Discovery",
            'status'=> "In progress",
            'success'=> "Yes",
            'created_at' => Carbon::now()->format('Y-m-d H:i:s'),
        ...
        DB::table('actions')->insert([
            ...
            'owner'=> "Events Team",
            'lead'=> "lmackenzie@epl.ca" . $SEPARATOR . "jmcphee@epl.ca",
            'collaborators'=> "Marketing" . $SEPARATOR . "Purchasing" . $SEPARATOR . "All branches",
            'status'=> "In progress",
        ...
        DB::table('actions')->insert([
            ...
            'date'=> \Carbon\Carbon::createFromDate(2016, 12, 01)->toDateTimeString(),
            'owner'=> "Events Team",
            'lead'=> "jmcphee@epl.ca",
            'collaborators'=> "Marketing" . $SEPARATOR . "ITS" . $SEPARATOR . "DLI",
            'status'=> "In progress",
        ...
        DB::table('actions')->insert([
            ...
            'owner'=> "Events Team",
            'lead'=> "jwoods@epl.ca",
            'collaborators'=> "Marketing" . $SEPARATOR . "Adult Services" . $SEPARATOR . "Fund Development" . $SEPARATOR . "Volunteers",
            'status'=> "In progress",
        ...
        DB::table('actions')->insert([
            ...
            'owner'=> "Events Team",
            'lead'=> "bcrittenden@epl.ca",
            'collaborators'=> "Marketing" . $SEPARATOR . "Fund Development" . $SEPARATOR . "Volunteers",
            'status'=> "Completed",
        ...
        DB::table('actions')->insert([
            ...
            'date'=> \Carbon\Carbon::createFromDate(2016, 01, 01)->toDateTimeString(),
            'owner'=> "Events Team",
            'lead'=> "sforemski@epl.ca" . $SEPARATOR . "Events person",
            'collaborators'=> "Marketing",
            'status'=> "Ongoing",
            'success'=> "",
            'created_at' => Carbon::now()->format('Y-m-d H:i:s'),
