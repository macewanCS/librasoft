...
class PlanController extends Controller
{
    ...
    public function createPlan(Request $request) {
        ...
        $action3->lead = $request->leadA3;
        $action3->collaborators = $request->collabA3;
        ...
        $action4->lead = $request->leadA4;
        $action4->collaborators = $request->collabA4;
        ...
        $action5->lead = $request->leadA5;
        $action5->collaborators = $request->collabA5;
        ...
        $action6->lead = $request->leadA6;
        $action6->collaborators = $request->collabA6;
        ...
        $action7->lead = $request->leadA7;
        $action7->collaborators = $request->collabA7;
        ...
        $action8->lead = $request->leadA8;
        $action8->collaborators = $request->collabA8;
